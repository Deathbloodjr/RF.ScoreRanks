...
namespace ScoreRanks.Plugins
{
    ...
    internal class ScoreRankUtility
    {
        ...
        public static ScoreRank GetScoreRank(int score, string songId, EnsoData.EnsoLevelType level)
        {
            var points = SongDataManager.GetSongDataPoints(songId, level);
            return GetScoreRank(score, points.ScoreRank);
        }
